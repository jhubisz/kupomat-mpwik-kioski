    ...
    public class RfidConfig
    {
        ...
        public RfidConfig()
        {
            ...
            { 
                ...
                if (_sterowanieRfidHuberOn)
                    RfidCardReader.Add(ReaderLocation.Huber, GetReaderConfig(ReaderLocation.Huber, "RfidHuber"));
                if (_sterowanieRfidRozdzielniaOn)
                    RfidCardReader.Add(ReaderLocation.Rozdzielnia, GetReaderConfig(ReaderLocation.Huber, "RfidRozdzielnia"));
                if (_sterowanieRfidToaletaOn)
                    RfidCardReader.Add(ReaderLocation.Toaleta, GetReaderConfig(ReaderLocation.Toaleta, "RfidToaleta"));
