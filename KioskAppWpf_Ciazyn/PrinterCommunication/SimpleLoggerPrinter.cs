...
{
    public class SimpleLoggerPrinter
    {
        private string _logPath
        {
            get
            {
                return "C:/KioskAppLogs/";
            }
        }
        ...
        public SimpleLoggerPrinter()
        {
            ...
            logFilename = _logPath + System.Reflection.Assembly.GetExecutingAssembly().GetName().Name + ".log";
        ...
        {
            var files = Directory.GetFiles(_logPath, "*_appLogs_*.log");
