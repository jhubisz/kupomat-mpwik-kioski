...
namespace OpcCommunication.Devices
{
    public class DevicesState
    {
        ...
        public bool ChztOk { get; set; }
        public bool ZasuwaOk { get; set; }
        public bool PressureOk { get; set; }
        ...
        public bool DeviceError
        {
            get
            {
                ...
                return !Power230Ok || !Power24Ok
                    ...
                    || (!TempMeterOk && !KioskConf.KioskBlockages[KioskBlockageType.MeasuringTemperature])
                    || (!ChztOk && !KioskConf.KioskBlockages[KioskBlockageType.MeasuringChzt])
                    || (!PressureOk && !KioskConf.KioskBlockages[KioskBlockageType.MeasuringPressure])
                    ...
                    || (!ZasuwaOk && !KioskConf.KioskBlockages[KioskBlockageType.Zasuwa])
                    || !ZasuwaOk
                    ;
            }
        }
        ...
        public override bool Equals(object obj)
        {
            if (obj is DevicesState)
            {
                return Power230Ok == ((DevicesState)obj).Power230Ok
                    ...
                    && ChztOk == ((DevicesState)obj).ChztOk
                    && PressureMeterOk == ((DevicesState)obj).PressureMeterOk
                    && ZasuwaOk == ((DevicesState)obj).ZasuwaOk
