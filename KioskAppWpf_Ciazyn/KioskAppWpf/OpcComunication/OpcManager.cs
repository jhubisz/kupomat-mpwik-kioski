...
namespace OpcCommunication
{
    public class OpcManager
    {
        ...
        public DevicesState CheckDeviceState(KioskConfiguration kioskConf)
        {
            ...
            DevicesState.PressureDumpError = (plcToKiosk & Client.Configuration.MaskPressureDumpError) != 0;
            DevicesState.PressurePumpOn = (plcToKiosk & Client.Configuration.MaskPressurePumpOn) != 0;
        ...
        public void CheckCodeState()
        {
            ...
            CheckCodeStateInt<OpcCommunication.Enums.StopCode>(StopCodeState, Client.Configuration.VarAddressPlcToKioskStopCode);
            CheckCodeStateInt<OpcCommunication.Enums.MeasCode>(MeasCodeState, Client.Configuration.VarAddressPlcToKioskMeasCode);
        }
