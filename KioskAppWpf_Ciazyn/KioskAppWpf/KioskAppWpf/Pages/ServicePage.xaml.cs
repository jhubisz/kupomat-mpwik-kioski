...
namespace KioskAppWpf.Pages
{
    public partial class ServicePage : Page
    {
        ...
        private static int _itemChztMeterIndex = 9;
        private static int _itemPressureMeterIndex = 10;
        private static int _itemProbeIndex = 11;
        private static int _itemProbeReadyIndex = 12;
        private static int _itemDistribution230VACIndex = 13;
        private static int _itemRack230VACIndex = 14;
        private static int _itemRack24VDCIndex = 15;
        private static int _itemRack24VDCUPSIndex = 16;
        private static int _itemRack12VDCIndex = 17;
        private static int _itemValveIndex = 18;
        private static int _itemScreenIndex = 19;
        private static int _itemScreenFullIndex = 20;
        private static int _itemGateIndex = 21;
        #endregion
        ...
        private static string _itemKioskDoorLabel = "Drzwiczki kiosku zamknięte";
        ...
        private static string _itemChztMeterLabel = "Pomiar CHZT";
        ...
        private static string _itemScreenFullLabel = "Sitopiaskownik pełny";
        #endregion

        #region right panel indexes
        private static int _itemZasuwaIndex = 0;
        //private static int _itemPumpRoomIndex = 0;
        //private static int _itemPumpRoomWorkIndex = 1;
        private static int _itemScreenRoomLeakIndex = 1;
        private static int _itemAugerIndex = 2;
        private static int _itemPreScreenIndex = 3;

        private static int _itemRfidIndex = 4;
        private static int _itemOpcIndex = 5;
        private static int _itemSqlIndex = 6;
        private static int _itemPrinterIndex = 7;
        private static int _itemKeyboardIndex = 8;
        private static int _itemRemoteSqlIndex = 9;
        #endregion
        #region right panel labels 
        private static string _itemZasuwaLabel = "Zasuwa";
        ...
        private static string _itemPreScreenLabel = "Separator części stałych";
        ...
        private void BindServiceItems()
        {
            ...
            if (opcDevicesState != null)
            {
                ...
                ServicePageItem itemChztMeter = new ServicePageItem(new ServicePageItemState() { Label = _itemChztMeterLabel, Error = !opcDevicesState.ChztOk, Index = _itemChztMeterIndex });
                spServiceItems.Children.Add(itemChztMeter);
            ...
            else
            {
                ...
                spServiceItems.Children.Add(itemTempMeter);
                ServicePageItem itemChztMeter = new ServicePageItem(new ServicePageItemState() { Label = _itemChztMeterLabel, Error = true, Index = _itemChztMeterIndex });
                spServiceItems.Children.Add(itemChztMeter);
            ...
            if (opcDevicesState != null)
            {
                ServicePageItem itemZasuwa = new ServicePageItem(new ServicePageItemState() { Label = _itemZasuwaLabel, Error = !opcDevicesState.ZasuwaOk, Index = _itemZasuwaIndex, Postion = ServiceScreenPostion.RightBox });
                spServiceItemsRight.Children.Add(itemZasuwa);
            ...
            {
                ServicePageItem itemZasuwa = new ServicePageItem(new ServicePageItemState() { Label = _itemZasuwaLabel, Error = true, Index = _itemZasuwaIndex, Postion = ServiceScreenPostion.RightBox });
                spServiceItemsRight.Children.Add(itemZasuwa);
        ...
        private void WorkerUpdaterWork(object sender, DoWorkEventArgs e)
        {
            while (true)
            {
                ...
                if (opcDevicesState != null)
                {
                    ...
                    {
                        workerUpdater.ReportProgress(0, new ServicePageItemState() { Label = _itemFlowMeterLabel, Error = !opcDevicesState.FlowOk, Index = _itemFlowMeterIndex });
                    }
                    ...
                    var tempChztItem = Dispatcher.Invoke((Func<ServicePageItem>)(() => ((ServicePageItem)spServiceItems.Children[_itemChztMeterIndex])));
                    if (tempChztItem.State.Error != !opcDevicesState.ChztOk)
                    {
                        workerUpdater.ReportProgress(0, new ServicePageItemState() { Label = _itemChztMeterLabel, Error = !opcDevicesState.ChztOk, Index = _itemChztMeterIndex });
                    }
                    var tempPressureItem = Dispatcher.Invoke((Func<ServicePageItem>)(() => ((ServicePageItem)spServiceItems.Children[_itemPressureMeterIndex])));
                    if (tempPressureItem.State.Error != !opcDevicesState.PressureMeterOk)
                    {
                ...
                if (opcDevicesState != null)
                {
                    var zasuwaItem = Dispatcher.Invoke((Func<ServicePageItem>)(() => ((ServicePageItem)spServiceItemsRight.Children[_itemZasuwaIndex])));
                    if (zasuwaItem.State.Error != !opcDevicesState.ZasuwaOk)
                    {
                        workerUpdater.ReportProgress(0, new ServicePageItemState() { Label = _itemZasuwaLabel, Error = !opcDevicesState.PumpRoomOk, Index = _itemZasuwaIndex, Postion = ServiceScreenPostion.RightBox });
                    }
