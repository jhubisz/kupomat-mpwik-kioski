...
namespace DbCommunication
{
    public class DbServerWrite
    {
        ...
        public bool ExportTransaction(TransactionDbRow transaction)
        {
            ...
            parameters.Add(new SqlParameter("@przeplywomierzStart", transaction.PrzeplywomierzIloscStart));
            parameters.Add(new SqlParameter("@przeplywomierzKoniec", transaction.PrzeplywomierzIloscKoniec));
            ...
            string query = "INSERT INTO [dbo].[Transakcja] ([Id],[KioskId],[RodzajSciekowId],[KlientId],[SamochodId],[KartaId],[NumerUmowy],[ZadeklarowanaIlosc],[ZlanaIlosc],[PrzeplywomierzIloscStart],[PrzeplywomierzIloscKoniec] "
                         + "   ,[TransakcjaStart],[ZrzutStart],[ZrzutKoniec],[TransakcjaKoniec],[PobranoProbeHarm],[PobranoProbeAlrm],[ZakonczonaPoprawnie],[PowodZakonczenia]) output INSERTED.ID "
                         + "VALUES (@id, @kioskId, @rodzajSciekowId, @klientId, @samochodId, @kartaId, @numerUmowy, @zadeklarowanaIlosc, @zlanaIlosc, @przeplywomierzStart, @przeplywomierzKoniec "
                         + "    , @transakcjaStart, @zrzutStart, @zrzutKoniec, @transakcjaKoniec, @pobranoProbeHarm, @pobranoProbeAlrm, @zakonczonaPoprawnie, @powodZakonczenia);";
        ...
        public bool ExportTransactionAddress(TransactionAddressDbRow transactionAddress)
        {
            ...
            string query = "INSERT INTO [dbo].[TransakcjaAdres] ([Id],[KioskId],[TransakcjaId],[ZadeklarowanaIlosc],[NumerUmowy],[AdresId],[FirmaId],[RodId],[RodNrDzialki]) output INSERTED.ID "
                         + "VALUES (@id, @kioskId, @transakcjaId, @zadeklarowanaIlosc, @numerUmowy, @adresId, @firmaId, @rodId, @rodNrDzialki);";
        ...
        public bool ExportTransactionParameters(TransactionParametersDbRow transactionParameters)
        {
            ...
            string query = "INSERT INTO [dbo].[TransakcjaParametry] ([Id],[KioskId],[TransakcjaId],[PhMin],[PhMax],[PhAvg],[PrzewodnoscMin],[PrzewodnoscMax],[PrzewodnoscAvg],[TempMin],[TempMax],[TempAvg],[ChztMin],[ChztMax],[ChztAvg]) output INSERTED.ID "
                         + "VALUES (@id, @kioskId, @transakcjaId, @phMin, @phMax, @phAvg, @przewodnoscMin, @przewodnoscMax, @przewodnoscAvg, @tempMin, @tempMax, @tempAvg, @chztMin, @chztMax, @chztAvg);";
        ...
        public bool CargoTypeUpdate(CargoTypeDbRow cargoType)
        {
            var parameters = new List<SqlParameter>();
            parameters.Add(new SqlParameter("@id", cargoType.Id));
            parameters.Add(new SqlParameter("@nazwa", cargoType.Nazwa));
            parameters.Add(new SqlParameter("@kioskId", cargoType.KioskId));
            parameters.Add(new SqlParameter("@dataStart", cargoType.DataStart));
            if (cargoType.DataKoniec.HasValue)
                parameters.Add(new SqlParameter("@dataKoniec", cargoType.DataKoniec));
            else
                parameters.Add(new SqlParameter("@dataKoniec", DBNull.Value));
            parameters.Add(new SqlParameter("@deleted", cargoType.Deleted));
            string query = query = "UPDATE [RodzajSciekow] "
                                 + "SET Nazwa = @nazwa, KioskId = @kioskId, "
                                 + "    DataStart = @dataStart, DataKoniec = @dataKoniec, Deleted = @deleted "
                                 + "WHERE Id = @id;";

            var serverParameters = new List<SqlParameter>();
            serverParameters.Add(new SqlParameter("@exportRowId", cargoType.ExportRowId));
            serverParameters.Add(new SqlParameter("@kioskId", LocalConnection.KioskId));
            string localQuery = "INSERT INTO [ExportRowExported] (ExportRowId, KioskId, ExportedDate) output INSERTED.ID "
                              + "VALUES (@exportRowId, @kioskId, GetDate());";
        ...
        public bool CargoTypeAdd(CargoTypeDbRow cargoType)
        {
            var parameters = new List<SqlParameter>();
            parameters.Add(new SqlParameter("@id", cargoType.Id));
            parameters.Add(new SqlParameter("@nazwa", cargoType.Nazwa));
            ...
            if (cargoType.DataKoniec.HasValue)
                ...
                parameters.Add(new SqlParameter("@dataKoniec", DBNull.Value));
            parameters.Add(new SqlParameter("@deleted", cargoType.Deleted));
            string query = query = "INSERT INTO [dbo].[RodzajSciekow]([Id],[Nazwa],[KioskId],[DataStart],[DataKoniec],[Deleted]) output INSERTED.ID "
                                 + "VALUES (@id, @nazwa, @kioskId, @dataStart, @dataKoniec, @deleted);";
        ...
        public bool KartaUpdate(KartaDbRow card)
        {
            ...
            parameters.Add(new SqlParameter("@kartaToiToi", card.KartaToiToi));
            parameters.Add(new SqlParameter("@pojemnoscToiToi", card.PojemnoscToiToi));
            ...
            string query = query = "UPDATE [Karta] "
                                 + "SET KartaId = @kartaId, PojemnoscToiToi = @pojemnoscToiToi, SamochodId = @samochodId, Blokada = @blokada "
                                 + "    , DataStart = @dataStart, DataKoniec = @dataKoniec, Deleted = @deleted "
                                 + "WHERE Id = @id;";
        ...
        public bool KartaAdd(KartaDbRow card)
        {
            ...
            if (card.DataKoniec.HasValue)
                ...
                parameters.Add(new SqlParameter("@dataKoniec", DBNull.Value));
            parameters.Add(new SqlParameter("@deleted", card.Deleted));
            string query = query = "INSERT INTO [Karta] (Id, KartaId, KartaWymianyTacki, KartaToiToi, PojemnoscToiToi, SamochodId, Blokada "
                                 + "    , DataStart, DataKoniec, Deleted) output INSERTED.ID "
                                 + "VALUES (@id, @kartaId, @kartaWymianyTacki, @kartaToiToi, @pojemnoscToiToi, @samochodId, @blokada, @dataStart, @dataKoniec, @deleted);";
