...
namespace OpcCommunication
{
    public class OpcManager
    {
        ...
        public CodeState<StopCode> StopCodeState { get; set; }
        ...
        public OpcManager(bool opcOn)
        {
            ...
            StopCodeState = new CodeState<StopCode>(Client.Configuration.PlcToKioskStopCode);
        ...
        public DevicesState CheckDeviceState(KioskConfiguration kioskConf)
        {
            ...
            if (Client.Configuration.VarAddressDumpPath != null)
            {
            ...
            {
                DevicesState.DumpPath = 0;
            }

            if (Client.Configuration.VarAddressCameraRegistration != null)
            ...
            DevicesState.ScreenRoomLeak = (plcToKiosk & Client.Configuration.MaskScreenRoomLeak) != 0;
            DevicesState.ScreenOk = true; // (plcToKiosk & Client.Configuration.MaskScreenOk) != 0;
            DevicesState.ScreenAuto = true; // (plcToKiosk & Client.Configuration.MaskScreenAuto) != 0;
            DevicesState.ScreenFull = false; // (plcToKiosk & Client.Configuration.MaskScreenFull) != 0;
            ...
            DevicesState.ChztOk = (plcToKiosk2 & Client.Configuration.MaskChztOk) != 0;
            DevicesState.ZasuwaOk = (plcToKiosk2 & Client.Configuration.MaskZasuwaOk) != 0;
        ...
        private DevicesState CheckDeviceStateNoOpc(KioskConfiguration kioskConf)
        {
            ...
            int.TryParse("1", out int dumpPath);
            DevicesState.DumpPath = dumpPath;
        ...
        public void BuildOpcParameters(KioskConfiguration config, bool printerOutOfPaperErrorState)
        {
            ...
            opcParameters.MonitoringTempOn = !config.KioskBlockages[KioskBlockageType.MeasuringTemperature];
            opcParameters.MonitoringChztOn = !config.KioskBlockages[KioskBlockageType.MeasuringChzt];
        ...
        public void StartSequenceToiToi()
        {
            DevicesSteering.SeqStartToiToi = true;
            DevicesSteering.SendSteering();
            DevicesState.Flow.FlowFlowCnt = 0;
            DevicesState.Flow.DumpStartTime = DateTime.Now;
        }
        ...
        public void SetGateOutOpen(bool open)
        {
            DevicesSteering.GateOutOpen = open;
            DevicesSteering.SendSteering();
        }
        ...
        public decimal GetTotalFlowValue()
        {
            if (OpcOn)
            {
                string totalFlowString = Client.ReadValue(Client.Configuration.VarAddressTotalFlow);
                ...
                return Math.Round(totalFlowDecimal, 1);
            } else
            {
                return 123.12m;
            }
        ...
        public void CheckCodeState()
        {
            ...
            CheckCodeStateInt<StopCode>(StopCodeState, Client.Configuration.VarAddressPlcToKioskStopCode);
