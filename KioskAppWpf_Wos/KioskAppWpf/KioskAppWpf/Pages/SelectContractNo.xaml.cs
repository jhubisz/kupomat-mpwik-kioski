...
namespace KioskAppWpf.Pages
{
    ...
    /// </summary>
    public partial class SelectContractNo : Page
    {
        ...
        private void BindNavigation()
        {
            ...
            //    gGoToManualEntry.Visibility = Visibility.Visible;
            //}
            //if (dbType == AddressDbType.Rod || dbType == AddressDbType.ToiToi)
            //{
            //    gGoToRegularCustomers.Visibility = Visibility.Hidden;
            //    gGoToManualEntry.Visibility = Visibility.Hidden;
            //}
        ...
        private void CargoDirectionPage_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            if (!(Keyboard.FocusedElement is TextBox))
            {
                if (e.Key == Key.Enter)
                {
                    ...
                    {
                        ((MainWindow)Application.Current.MainWindow).UpdateTransactionAddressContractNo(tbNumer.Text);
                    }
                }
                ...
                if (e.Key == Key.B)
                {
                    if (String.IsNullOrEmpty(SelectedNumer))
                    {
                        ((MainWindow)Application.Current.MainWindow).UpdateTransactionAddressContractNo("");
                    }
                }
