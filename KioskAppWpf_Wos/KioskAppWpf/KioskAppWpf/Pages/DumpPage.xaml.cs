...
namespace KioskAppWpf.Pages
{
    ...
    public partial class DumpPage : Page
    {
        ...
        private void BindPage()
        {
            ...
            spPrzeplyw.Visibility = Visibility.Visible;
            spObjetosc.Visibility = Visibility.Visible;
            spPomiarPh.Visibility = Visibility.Visible;
            spPomiarTemp.Visibility = Visibility.Visible;
            spChzt.Visibility = Visibility.Visible;
            RunFlowWorker();
        }
        ...
        private void BindFlowData(Flow flow)
        {
            ...
            if (Transaction.Card.Type != RfidCardType.ToiToi)
                ...
                tbDeclaredAmount.Text = Transaction.Card.Pojemnosc.ToString("0.00");
            ...
            if (!kioskConfig.KioskBlockages[KioskBlockageType.MeasuringTemperature])
            {
