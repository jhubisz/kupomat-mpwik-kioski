...
namespace KioskAppWpf.Pages
{
    ...
    public partial class AddressSummary : Page
    {
        ...
        private void BindAddress()
        {
            ...
            else if (Transaction.Cargo.Id == 4) // Toalety przenośne
            {
                spCompanyName.Visibility = Visibility.Collapsed;
                spGmina.Visibility = Visibility.Collapsed;
                spMiejscowosc.Visibility = Visibility.Collapsed;
                spUlica.Visibility = Visibility.Collapsed;
                spNrPosesji.Visibility = Visibility.Collapsed;
            }
            else
            {
                spCompanyName.Visibility = Visibility.Collapsed;
