...
namespace PrinterCommunication
{
    public class PrinterManager
    {
        ...
        private PrintDoc BuildReciptContent()
        {
            ...
            if (Transaction.Parameters != null && !KioskConf.KioskBlockages[KioskBlockageType.MeasugingTemperature])
            {
                printDoc.Lines.Enqueue(
                new PrintLine()
                {
        ...
        {
            if (String.IsNullOrEmpty(KioskConf.KioskWiadomosc))
                return null;
