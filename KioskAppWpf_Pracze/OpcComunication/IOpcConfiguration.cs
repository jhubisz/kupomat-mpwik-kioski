...
namespace OpcCommunication
{
    public interface IOpcConfiguration
    {
        ...
        string VarAddressPressureFactor { get; }
        string VarAddressPressureMaxTime { get; }
        ...
        string VarAddressCameraRegistration2 { get; }

        string VarAddressStopCode { get; }
        ...
        uint MaskPressureDumpError { get; }
        uint MaskPressurePumpOn { get; }

        uint MaskPressureOk { get; }
        #endregion
        ...
        uint MaskBottlesBlockage { get; }
        uint MaskProbeErrorBlockage { get; }

        uint MaskPressureOn { get; }
