        ...
        public Dictionary<KioskBlockageType, bool> KioskBlockages
        {
            get
            {
                if (kioskBlockages == null)
                {
                    ...
                    kioskBlockages.Add(KioskBlockageType.MeasugingTemperature, false);
                    kioskBlockages.Add(KioskBlockageType.MeasuringPressure, false);
        ...
        public Dictionary<KioskConfigurationType, short> ConfigurationSettings
        {
            get
            {
                if (configurationSettings == null)
                {
                    ...
                    configurationSettings.Add(KioskConfigurationType.PressureFactor, 0);
                    configurationSettings.Add(KioskConfigurationType.PressureMaxTime, 0);
                }
